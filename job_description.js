...
JobDescription.prototype.validate = function(cb) {
    ...
    //Added to permit seperate directory for hadoop*streaming*.jar
    if(this.configuration.hadoopStreamingHome == null)
        var hadoopStreamingHome = hadoopHome + "/contrib/streaming";

    // Added to fix any issues with wildcards in hadoop*streaming*.jar
    if(this.configuration.hadoopStreamingJar == null)
        var hadoopStreamingJar = "hadoop*streaming*.jar";
...
JobDescription.prototype.execute = function(index, cb) {
    ...
    var command = this.configuration.hadoopHome+"/bin/hadoop jar "+this.configuration.hadoopStreamingHome+"/"+this.configuration.hadoopStreamingJar;
